...
public class TodoJpaResource {
	...
	**/
	...
	public ResponseEntity<Todo> updateTodo(@PathVariable String username, 
		...
		System.out.println("This is todo 1" + todo);
		Todo todoUpdate = todoJpaRepository.save(todo);
		
		System.out.println("This is todo update:" + todoUpdate);
		System.out.println("This is todo 2:" + todo);
	...
	//POST /users/{username}/todos
		...
		public ResponseEntity<Void> createTodo(@PathVariable String username, 
			...
			System.out.println("createTodo.getId == " +  createTodo.getId());
